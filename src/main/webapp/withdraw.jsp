...
<h1 style="background-color:Tomato;">
    &emsp; Withdraw. It's easy now.
        ...
        <form action="WithdrawServlet" method="post"><br>
            ...
            <h3>Withdraw amount : <input type="number" name="withdrawMoney"/></h3><br> <br>
            &emsp; &emsp; &emsp; &emsp; &emsp; &emsp;   <input class="button button1" type="submit" value="Withdraw"/>
